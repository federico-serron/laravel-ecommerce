<div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        <aside>
            ...
            <x-jet-button class="mt-4" wire:click="limpiar">Eliniar filtros</x-jet-button>
        </aside>
                ...
                <ul>
                    @foreach ($products as $product)
                        <li class="bg-white rounded-lg shadow-lg mb-4">
                            <article class="flex">
                                <figure>
                                    <img class="h-48 w-56 object-cover object-center rounded-l-lg" src="{{Storage::url($product->images->first()->url)}}" alt="">
                                </figure>
